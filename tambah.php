...
<head>
    ...
    <style>
        ...
        input[type="text"], input[type="email"], textarea, select {
            width: 100%; padding: 8px; border: 1px solid #bbb; border-radius: 6px; font-size: 14px; background-color: #f9f9f9; color: #333;
        }
        ...
        input[type="submit"]:hover, .cancel-btn:hover { background-color: #555; }
        .button-group { display: flex; justify-content: center; gap: 10px; }
        a { background-color: #666; color: white; text-decoration: none; padding: 8px 16px; border-radius: 6px; transition: background-color 0.3s ease; }
